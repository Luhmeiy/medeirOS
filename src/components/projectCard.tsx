...
const ProjectCard = ({ project }: { project: IProject }) => {
	return (
		<div
			...
			className={`group min-w-96 w-96 hover:w-[36rem] relative flex-shrink-0 flex flex-col justify-end gap-3 ${
		...
		>
			...
			<div className="w-80 flex gap-2 flex-wrap max-h-16 group-hover:max-h-none overflow-hidden transition-all z-10">
